...
func _ready():
	...
	queue_text("Wizard: Well you see, I once had a great team of adventurers")
	queue_text("Wizard: Sadly, I lost them all in this very dungeon.")
	queue_text("Wizard: I was able to safely escape due to my teleportation ability")
	queue_text("Wizard: But I vowed that no one else will be able to beat this dungeon")
	queue_text("You: I'm sorry for your loss however you should not hurt others")
	queue_text("You: You should become a guiding beacon for the future generations")
